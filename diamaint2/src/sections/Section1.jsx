    ...
    <section>
      <div className='flex justify-center mt-[0px] sm:mt-[127px] relative'>
        <div className='w-[1280px]'>
          <h1
            className="font-serif sm:mb-[1733px] mb-[1500px] sm:text-[230px] leading-[212.52px] text-[50px] text-[#515076] relative z-10 sm:text-left text-center"
            style={{ fontFamily: "Playfair Display" }}
          >
            Diamaint
          </h1>

          <div className='absolute sm:top-[332px] top-[250px] text-center sm:left-[630px] z-10 flex flex-col left-1/2 -translate-x-1/2'>
          ...
          {isScreenSmall < 650 ? '' : <img className='absolute top-[-240px] left-[335px] w-[1240px]' src={flower} alt="flower-img"/>}

          <img src={leaves} alt="leaves-img" className='absolute top-[505px] left-[0px]' />
          {isScreenSmall < 650 ? '' : (
            <p className='font-[Montserrat] font-normal text-[18px] sm:text-[36px] leading-[47.76px] text-[#63678C] w-[320px] absolute sm:top-[435px] top-[332px] lm:left-[110px] sm:left-[170px] left-0'>
          ...
          {isScreenSmall < 650 ? '' : <p className="font-[Montserrat] font-light text-[36px] leading-[39.38px] text-[#757AA5] absolute left-[1039px] top-[1213px] z-10">
            Diamaint — только <br /> натуральные <br /> ингридиенты
          </p>}

          <p className="font-[Montserrat] font-normal text-[18px] leading-[30.6px] text-[#888794] absolute top-[1286px] sm:left-[335px] z-10 left-1/2 -translate-x-1/2 text-center sm:text-left">
          ...
          {isScreenSmall < 650 ? '' : <img className='absolute top-[777px] left-[160px] sm:w-[1300px] w-[1500px]' src={blueber} alt="blueber" />}
        </div>
      </div>
    </section>
  );
